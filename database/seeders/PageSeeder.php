    ...
    protected function pages(): array
    {
        return [
            ...
            [
                ...
                'body' => '<h2>Information we collect</h2><p>We collect the information you choose to give us through our contact, subscription and volunteer forms — such as your name, email address, phone number and organisation.</p><h2>Website statistics</h2><p>We keep a record of the pages opened on this website so that we can see which research is useful and improve the site. For each page view we store the page address, the date and time, the page you arrived from, your browser, operating system and device type, and an approximate location (country, region and city) worked out from your IP address. IP addresses are shortened before they are stored, so they cannot be traced back to an individual, and we use no advertising cookies and share these statistics with no advertiser. The site can also be set to skip this record for browsers that send a “Do Not Track” signal.</p><h2>How we use your information</h2><p>We use your information to respond to your enquiry, to send you the EPIC newsletter and event invitations when you have asked for them, and to understand how our website is used. We do not sell your information.</p><h2>Sharing</h2><p>We share personal information only with service providers who help us operate the website and our mailing list, and where we are required to do so by law.</p><h2>Your choices</h2><p>You can unsubscribe from our mailing list at any time using the link in our emails, or by writing to us. You may also ask us to correct or delete the information we hold about you.</p><h2>Contact</h2><p>Questions about this policy can be sent to our team using the details on the contact page.</p>',
            ],
